...
class CustomSchemaGenerator(SchemaGenerator):
    """
    desc: Create a Example User instance, you can reference to the type https://swagger.io/specification/
    parameters:
    - name: username
      desc: the user name
      type: string
...
def get_swagger_view1(title=None, url=None, patterns=None, urlconf=None):
    """
